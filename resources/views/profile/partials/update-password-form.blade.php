<section>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="update_password_current_password" :value="__('Password Attuale')" class="dark:text-gray-300" />
        ...
        <div>
            <x-input-label for="update_password_password" :value="__('Nuova Password')" class="dark:text-gray-300" />
        ...
        <div>
            <x-input-label for="update_password_password_confirmation" :value="__('Conferma Password')" class="dark:text-gray-300" />
